...
import client.api.sale.ErpSaleSycnApiClient;
 ...
 */
@Controller
@RequestMapping(value = "/anxian/promotionSycn")
public class SaleErpSycnController extends BaseController {
    ...
    @Autowired
    private ErpSaleSycnApiClient erpSaleSycnApiClient;
    ...
    public String syncList(Model model, Principal principal) {
        ...
        getMenus(user, model);
        return "/anXian-promotion/sale-sync";
    }
    ...
    public SjesPage<PromotionSycnView> pageList(@RequestParam(name = "promotionName", required = false) String promotionName,
        ...
        SjesPage<PromotionSycnView> sjesPage = new SjesPage<>();
        sjesPage = erpSaleSycnApiClient.getPages(erpSaleDTO);
        return sjesPage;
    }
    ...
    public JsonMsg getById(@PathVariable("id") String id) {
        ...
        PromotionSycnViewModel promotionSycnViewModel = erpSaleSycnApiClient.getById(id);
    ...
    public JsonMsg updateBenefitVolume(@RequestBody PromotionSyncModel promotionSyncModel) {
        ResponseMessage<PromotionSync> promotionSycnResponseMessage = erpSaleSycnApiClient.savePromotionSycn(promotionSyncModel);
    ...
    public JsonMsg delBySheetId(@PathVariable("sheetId") String sheetId) {
        ResponseMessage responseMessage = erpSaleSycnApiClient.delBySheetId(sheetId);
    ...
    public String turnToSyncEdit(@PathVariable("id") String id, Model model, Principal principal){
        ...
        return "anXian-promotion/edit-sale-sync";
    }
}
